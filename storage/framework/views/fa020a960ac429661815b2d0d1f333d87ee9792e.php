...
<head>
    ...
    <title><?php echo e($invoice->seller_name); ?> | Invoice</title>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="<?php echo e(config('app.app_public_path')); ?>/css/AdminLTE.min.css">
    ...
    <script src="<?php echo e(config('app.app_public_path')); ?>/js/qrcode.js"></script>
    <style>
        body {
    ...
    <?php endif; ?>
    <link rel="stylesheet" media="print" href="<?php echo e(config('app.app_public_path')); ?>/css/invoice-print.css">
</head>
                ...
                <div class="row mid_header">
                    ...
                    <div class="col-md-5 col-xs-5">
                            <div class="invoice-col">
                                ...
                                <address class="base_color">
                                    <div class="customer_name color_theme"><?php echo e($invoice->customer_name); ?></div>
                                    <div><strong>Mobile </strong> <?php echo e($invoice->customer_mobile); ?></div>
                                    <div><strong>Email </strong> <?php echo e($invoice->customer_email); ?></div>
                                    <div style="text-transform:capitalize;"><strong>Address </strong> <?php echo e($invoice->customer_address); ?></div>
                                    <div style="text-transform:uppercase;"><strong>GST </strong> <?php echo e($invoice->buyer_gstin); ?></div>
                                </address>
                            </div>
                    </div>
                    <div class="col-md-7 col-xs-7">
                        ...
                        <div class="invoice_number">
                            <div>
                                Date: <?php echo e(date('d-M-Y', strtotime($invoice->created_at))); ?>

                            </div>
                            <div>
                                Invoice No: <?php echo e($invoice->invoice_number); ?>
                    ...
                    <table class="table table-striped table-bordered item_table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="dark"><?php echo e(($item->type=="treatment") ?config('app_config.TREATMENT_SAC_NUMBER'):$item->hsn_number); ?></td>
                                <td><span class='WebRupee'>Rs. </span><?php echo e($item->item_cost_without_tax); ?></td>
                                <td><?php echo e($item->quantity); ?></td>
                                <td><?php echo e($item->discount); ?> %</td>
                                <td><?php echo e($item->tax_percent); ?> %</td>
                                <td class="dark"><span class='WebRupee'>Rs. </span><?php echo e(round($item->sub_total, 2)); ?></td>
                            </tr>
                ...
                <div class="row ">
                    ...
                    <div class="col-xs-5">
                        <!-- <hr style="margin-top:10px;margin-bottom:10px;"> -->
                            <div>Seller's GSTIN: <span><?php echo e($invoice->seller_gstin); ?> </span> </div>
                            <div>Seller's PAN: <span><?php echo e($invoice->seller_pan); ?> </span> </div>
                            <div>Seller's CIN: <span><?php echo e($invoice->seller_cin); ?> </span> </div>
                        </div>
                    <div class="col-xs-2">
                    ...
                    <div class="col-xs-5 totals-col">
                        <div class="row">
                            ...
                            <div class="col-xs-7 total_value"><span class='WebRupee'>Rs. </span> <?php echo e($invoice->total_without_tax); ?></div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-xs-5 total_heading">Discount:</div>
                            <div class="col-xs-7 total_value"><span class='WebRupee'>Rs. </span> <?php echo e($invoice->total_discount); ?></div>
                        </div>
                        <hr>
                        <?php if($invoice->customer_state == $invoice->seller_state): ?>
                        <div class="row">
                            <div class="col-xs-5 total_heading">SGST:</div>
                            <div class="col-xs-7 total_value"><span class='WebRupee'>Rs. </span> <?php echo e(round($invoice->total_tax/2, 2)); ?></div>
                        </div>
                        <hr>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-7 total_value"><span class='WebRupee'>Rs. </span> <?php echo e($invoice->total_tax); ?></div>
                        </div>
                        <?php endif; ?>
                        <hr>
                    </div>
                ...
                <div class="row" style="margin-top:10px;">
                    ...
                    <div class="col-xs-7">
                        <div>
                            ...
                            <div class="col-xs-7 grand_total_value grand_total_row"><span class='WebRupee'>Rs. </span> <?php echo e($invoice->total); ?></div>
                        </div>
                    </div>
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-xs-6">
                        <div class="row">
                            <div class="col-xs-12 border_black t_c">
                                ...
                                <?php $__currentLoopData = config('app_config.SELLER_TERMS_AND_CONDITIONS'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $term): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div>- <?php echo e($term); ?></div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6 border_black seller_info">
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div><span style="font-weight:bold;">Bank:</span> <span><?php echo e($invoice->seller_bank); ?> </span> </div>
                                <div><span style="font-weight:bold;">Branch:</span> <span><?php echo e($invoice->seller_branch); ?> </span> </div>
                                <div><span style="font-weight:bold;">IFS Code:</span> <span><?php echo e($invoice->seller_ifsc); ?> </span> </div>
                                <div><span style="font-weight:bold;">Account:</span> <span><?php echo e($invoice->seller_account_number); ?> </span> </div>
                            </div>
                        </div>
                        <div class="row signature_wrapper">
                            <div class="col-xs-12">
                                <div class="signature_border">
                                    <div class="seller_name"><?php echo e($invoice->seller_name); ?></div>
...
<script>
    var qrcode = new QRCode("qrcode", {
        text: "<?php echo e($invoice->customer_name); ?>: <?php echo e($invoice->seller_name); ?> | Total Amount Due: Rs. <?php echo e($invoice->total); ?>",
        width: 96,
        height: 96,
        colorDark: "#000000",
        colorLight: "#ffffff",
    ...
    $(function(){
        $('#amount_in_words').html(RsPaise( Math.round( <?php echo e($invoice->total); ?> * 100) / 100  ));
